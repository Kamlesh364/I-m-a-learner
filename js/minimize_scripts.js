...
function RefreshParallaxImages() {
    $(document).on('s123.page.ready.refreshParallaxImages', function(event) {
        ...
        if (parallaxWindows.length === 0 || $('html').hasClass('parallax-disabled'))
            return;
...
function Parallax_active(active) {
    if (active) {
        if ($('html').hasClass('parallax-active'))
            return;
...
function OpenModuleManagment_wizardV_beta() {
    $(document).on('s123.page.ready.wizard_preview_manage_helpers', function(event) {
        if (!IsWizard())
            return;
        (function() {
            $('.header-phone-wrapper').add('.header-address-wrapper').add('.header-social-wrapper').off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
                expandWizardHomepage('designTab', '#collapseHeaderOptions');
            });
        }
        )();
        $('#mainNav .logo_name').add('#mainNav .s123-site-logo').add('#header .header-logo .s123-site-logo').add('#header .logo_name').add('#mainNavMobile .logo_name').add('.website-name-preview-helper').each(function() {
            var $this = $(this);
        ...
        $('#home_siteSlogan').add('#home_siteSlogan_2').add('#home_SecondSiteSlogan').each(function() {
            var $this = $(this);
            $this.off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
        ...
        $('.s123-page-header').each(function() {
            var $this = $(this);
            $this.off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
        ...
        (function() {
            ...
            if ($global_contact_details_container.length === 0)
                return;
            ...
            $global_contact_details_container.off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
                if (topWindow.$('#collapseHeaderOptionsEnterPhoneNumber > a').length === 0)
                    return;
        ...
        (function() {
            $('.contact-as-details-container').each(function(index) {
                ...
                $contact_as_details_container.find('a').attr('data-allow-external-link', 'true')// prevent from the external links alert to be shown
        ...
        (function() {
            $('.social-details-container').each(function(index) {
                ...
                $social_details_container.find('a').attr('data-allow-external-link', 'true')// prevent from the external links alert to be shown
                .off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
                    event.preventDefault();
                });
                $social_details_container.off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
                    if (topWindow.$('#showSocialEditButtonForHeader').length === 0)
                        return;
        ...
        (function() {
            $('.upgrade-website-preview-helper').each(function(index) {
                ...
                $upgrade_website_preview_helper.find('a').attr('data-allow-external-link', 'true')// prevent from the external links alert to be shown
                .off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
                    event.preventDefault();
                });
                $upgrade_website_preview_helper.off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
                    if (topWindow.$('#upgradePackage').length === 0)
                        return;
        ...
        $previewManageButton.each(function(index) {
            ...
            case 'homepage':
                ...
                if (topWindow.$('#homepage_goal_type').val() != 'no') {
                    $pmb.find('[data-action="homepage_goal"]').on('click.p_m_buttons', function(event) {
                        event.preventDefault();
                        expandWizardHomepage('homepageTab', '#homepageImageOptionsTab');
                    }).css({
                        display: 'flex'
                ...
                if (true) {
                    $pmb.find('[data-action="edit"]').on('click.p_m_buttons', function(event) {
                        event.preventDefault();
                        expandWizardHomepage('homepageTab', '#homepageCollapse88');
                    }).css({
                        display: 'flex'
                ...
                if (true) {
                    $pmb.find('[data-action="image"]').on('click.p_m_buttons', function(event) {
                        event.preventDefault();
                        expandWizardHomepage('homepageTab', '#backgroundOptionsTab');
                    }).css({
                        display: 'flex'
                ...
                $pmb.find('[data-action="layouts"]').on('click.p_m_buttons', function(event) {
                    event.preventDefault();
...
function OpenModuleManagment_wizardV4_beta() {
    $(document).on('s123.page.ready.wizard_preview_manage_helpers', function(event) {
        ...
        (function() {
            $('.header-phone-wrapper').add('.header-address-wrapper').add('.header-social-wrapper').add('.header-email-wrapper').each(function() {
                var $this = $(this);
        ...
        $('#s123ModulesContainer .s123-page-header').each(function() {
            var $this = $(this);
            highlightEditedElements($this);
            $this.off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
                topWindow.OpenWizardTab('pagesTab', true);
        ...
        $('.s123-page-slogan').each(function() {
            var $this = $(this);
            highlightEditedElements($this);
            $this.off('click.p_m_helpers').on('click.p_m_helpers', function(event) {
                topWindow.OpenWizardTab('pagesTab', true);
        ...
        ;function addFloatingMenu($options) {
            if ($options.$element.find('.p-m-b-floating-menu').length !== 0)
                return;
...
function WizardNotificationUpdate() {
    if (IsWizard())
        topWindow.Wizard.Notification.update();
}
...
var WishList = function() {
    ...
    WL.markUnMarkIcons = function() {
        ...
        if (!WL.items || $container.length === 0)
            return;
    ...
    WL.updateCounterIcon = function() {
        ...
        if ($headerWishListWrapper.length === 0)
            return;
